                                        ...
                                        <tbody>
                                            ...
                                            <?php foreach ($buku as $index => $b) : ?>
                                                <tr>
                                                    ...
                                                    <td><img src="<?php echo base_url('uploads/sampul/' . $b['sampul']); ?>" alt="Sampul" height="100px"></td>
                                                    ...
                                                    <td>
                                                        <img src="<?php echo base_url('uploads/qrcodes/qrbuku/' . $b['qr_code']); ?>" alt="QR Code" height="100px">
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
                                        </tbody>
